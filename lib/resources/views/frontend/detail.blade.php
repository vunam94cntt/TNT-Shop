                ...
                <div class="col-md-6 md-margin-bottom-50">
                    <div class="ms-showcase2-template">
                        ...
                        <div class="master-slider ms-skin-default" id="masterslider">
                            <div class="ms-slide">
                                <img class="ms-brd" src="img/blank.gif" data-src="img/blog/28.jpg" alt="lorem ipsum dolor sit">
                                <img class="ms-thumb" src="img/blog/28-thumb.jpg" alt="thumb">
                            </div>
                            <div class="ms-slide">
                                <img src="img/blank.gif" data-src="img/blog/29.jpg" alt="lorem ipsum dolor sit">
                                <img class="ms-thumb" src="img/blog/29-thumb.jpg" alt="thumb">
                            </div>
                            <div class="ms-slide">
                                <img src="img/blank.gif" data-src="img/blog/30.jpg" alt="lorem ipsum dolor sit">
                                <img class="ms-thumb" src="img/blog/30-thumb.jpg" alt="thumb">
                            </div>
                        </div>
                        <!-- End Master Slider -->
                    </div>
                ...
                <div class="tab-pane fade" id="reviews">
                    <div class="product-comment margin-bottom-40">
                        <div class="product-comment-in">
                            <img class="product-comment-img rounded-x" src="img/team/01.jpg" alt="">
    ...
    <div class="container">
        ...
        <div class="illustration-v2 margin-bottom-60">
            <div class="customNavigation margin-bottom-25">
                <a class="owl-btn owl-slider-v4-prev rounded-x"><i class="fa fa-angle-left"></i></a>
                <a class="owl-btn owl-slider-v4-next rounded-x"><i class="fa fa-angle-right"></i></a>
            </div>

            <ul class="list-inline owl-slider-v4">
                <li class="item">
                    <a href="#"><img class="img-responsive" src="img/thumb/09.jpg" alt=""></a>
                ...
                <li class="item">
                    <a href="#"><img class="img-responsive" src="img/thumb/07.jpg" alt=""></a>
                    <div class="product-description-v2">
                        <div class="margin-bottom-5">
                            <h4 class="title-price"><a href="#">Double-breasted</a></h4>
                ...
                <li class="item">
                    <a href="#"><img class="img-responsive" src="img/thumb/08.jpg" alt=""></a>
                    <div class="product-description-v2">
                        <div class="margin-bottom-5">
                            <h4 class="title-price"><a href="#">Double-breasted</a></h4>
                            <span class="title-price">$95.00</span>
                ...
                <li class="item">
                    <a href="#"><img class="img-responsive" src="img/thumb/06.jpg" alt=""></a>
                    <div class="product-description-v2">
                        <div class="margin-bottom-5">
                            <h4 class="title-price"><a href="#">Double-breasted</a></h4>
                            <span class="title-price">$95.00</span>
                ...
                <li class="item">
                    <a href="#"><img class="img-responsive" src="img/thumb/04.jpg" alt=""></a>
                    <div class="product-description-v2">
                        <div class="margin-bottom-5">
                            <h4 class="title-price"><a href="#">Double-breasted</a></h4>
                            <span class="title-price">$95.00</span>
                ...
                <li class="item">
                    <a href="#"><img class="img-responsive" src="img/thumb/03.jpg" alt=""></a>
                    <div class="product-description-v2">
                        <div class="margin-bottom-5">
                            <h4 class="title-price"><a href="#">Double-breasted</a></h4>
                            <span class="title-price">$95.00</span>
