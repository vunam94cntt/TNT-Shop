...
<head>
    ...
    <!-- CSS Page Style -->
    <link rel="stylesheet" href="../assets/css/css-rtl/pages/log-reg-v3-rtl.css">
...
<script src="../assets/js/forms/page_login.js"></script><script src="../assets/js/forms/page_contact_form.js"></script>
<script>
