...
@section('title','Home')
    ...
    <div class="container content-md">
        ...
        <div class="row margin-bottom-60">
                    ...
                    <div class="illustration-v1 illustration-img1">
                        <div class="illustration-bg">
                            <div class="illustration-ads ad-details-v1">
                                ...
                                <a class="btn-u btn-brd btn-brd-hover btn-u-light" href="../../home">Shop Now</a>
                            </div>    
                        </div>    
                    </div>
                </div>    
            ...
            <div class="col-md-6">
                <div class="overflow-h">
                    <a class="illustration-v1 illustration-img2" href="../../home">
        ...
        <div class="illustration-v2 margin-bottom-60">
            <div class="customNavigation margin-bottom-25">
                <a class="owl-btn owl-slider-prev rounded-x"><i class="fa fa-angle-left"></i></a>
                <a class="owl-btn owl-slider-next rounded-x"><i class="fa fa-angle-right"></i></a>
            </div>

            <ul class="list-inline owl-slider">
                <li class="item">
                    <div class="product-img">
                        <a href="../../detail"><img class="full-width img-responsive" src="img/blog/09.jpg" alt=""></a>
                        <a class="product-review" href="../../detail">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div>
                    <div class="product-description product-description-brd">
                        <div class="overflow-h margin-bottom-5">
                            <div class="pull-left">
                                <h4 class="title-price"><a href="../../detail">Double-breasted</a></h4>
                        ...
                        <ul class="list-inline product-ratings">
                            ...
                            <li><i class="rating fa fa-star"></i></li>
                            <li class="like-icon"><a data-original-title="Add to wishlist" data-toggle="tooltip" data-placement="right" class="tooltips" href="#"><i class="fa fa-heart"></i></a></li>
                        </ul>    
                    </div>
                </li>
                <li class="item">
                    <div class="product-img">
                        <a href="../../detail"><img class="full-width img-responsive" src="img/blog/26.jpg" alt=""></a>
                        <a class="product-review" href="../../detail">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div> 
                    <div class="product-description product-description-brd">
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="../../detail"><img class="full-width img-responsive" src="img/blog/11.jpg" alt=""></a>
                        <a class="product-review" href="../../detail">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="../../detail"><img class="full-width img-responsive" src="img/blog/12.jpg" alt=""></a>
                        <a class="product-review" href="../../detail">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="../../detail"><img class="full-width img-responsive" src="img/blog/10.jpg" alt=""></a>
                        <a class="product-review" href="../../detail">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div> 
                    <div class="product-description product-description-brd">
        ...
        <div class="row illustration-v2">
            <div class="col-md-3 col-sm-6 md-margin-bottom-30">
                <div class="product-img">
                    <a href="../../detail"><img class="full-width img-responsive" src="img/blog/25.jpg" alt=""></a>
                    <a class="product-review" href="../../detail">Quick review</a>
                    <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                </div>
                <div class="product-description product-description-brd">
                    <div class="overflow-h margin-bottom-5">
                        <div class="pull-left">
                            <h4 class="title-price"><a href="../../detail">Double-breasted222</a></h4>
            ...
            <div class="col-md-4">
                ...
                <div class="thumb-product">
                    ...
                    <div class="thumb-product-in">
                        <h4><a href="../../detail">Yuketen</a> – <a href="../../detail">Derby Shoe</a></h4>
    ...
    <div class="container content">
        ...
        <ul class="list-inline owl-slider-v2">
            <li class="item first-child">
                <img src="img/clients/07.png" class="owl-img-auto" alt="">
            </li>
            <li class="item">
                <img src="img/clients/08.png" class="owl-img-auto" alt="">
            </li>
            <li class="item">
                <img src="img/clients/10.png" class="owl-img-auto" alt="">
            </li>
            <li class="item">
                <img src="img/clients/11.png" class="owl-img-auto" alt="">
            </li>
            <li class="item">
                <img src="img/clients/09.png" class="owl-img-auto" alt="">
            </li>
            <li class="item">
                <img src="img/clients/12.png" class="owl-img-auto" alt="">
            </li>
            <li class="item">
                <img src="img/clients/07.png" class="owl-img-auto" alt="">
            </li>
